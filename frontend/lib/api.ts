...
export const tasksAPI = {
  ...
  create: (projectId: string, title: string, agentType: string, description?: string) =>
  ...
  chatStream: (taskId: string, message: string) =>
    api.post(`/tasks/${taskId}/chat/stream`, { message }, { responseType: 'stream' }),
};
...
export const agentsAPI = {
  ...
  chatStream: (agentType: string, message: string) =>
    api.post('/agents/chat/stream', { agentType, message }, { responseType: 'stream' }),
};
